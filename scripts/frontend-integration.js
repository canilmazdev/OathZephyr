 ...
 * This file demonstrates how to integrate Oathzephyr with a web frontend
 */

// For React/Vue/Angular applications
export class OathzephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OathzephyrClient(provider, contractAddress);
